...
public class TeacherDAOImpl implements ITeacherDAO {
    ...
    public Teacher update(Teacher teacher) throws TeacherDAOException {
        String sql = "UPDATE teachers SET firstname = ?, lastname = ?, vat = ?, fathername = ?, phone_num = ?, email = ?, street = ?," +
                " street_num = ?, zipcode = ?, city_id = ?, uuid, created_at, " + "updated_at = ? WHERE id = ?)";
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            if (rs.next()) {
                teacher = new Teacher(rs.getInt("id"), rs.getString("firstname"), rs.getString("lastname"), rs.getString("vat"),
                        rs.getString("fathername"), rs.getString("phone_num"), rs.getString("email"), rs.getString("street"), rs.getString("street_num"),
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("SQL Error. Teacher with id: " + id + " error while searching.");
        }
    }
    ...
    public List<Teacher> getAll() throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("SQL Error in Get All Teachers");
        }
    }
    ...
    public Teacher getByUUID(String uuid) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("SQL Error. Teacher with id: " + uuid + " error while searching.");
        }
    }
    ...
    public List<Teacher> getByLastname(String lastname) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("SQL Error in Get By Lastname");
        }
    }
    ...
    public Teacher getTeacherByVat(String vat) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            e.printStackTrace();
            // logging
            throw new TeacherDAOException("SQL Error. Teacher with id: " + vat + " error while searching.");
        }
    }
}
